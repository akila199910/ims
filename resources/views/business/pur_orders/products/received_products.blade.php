...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col-sm-8">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('business.purchaseorder') }}">Purchase Orders</a></li>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <span style="font-size: 14px">{{ $purchase['supplier_info']['supplier_name'] }}</span><br>
                                <span
                                    style="font-size: 14px">{{ $purchase['supplier_info']['supplier_address'] }}</span><br>
                                <span style="font-size: 14px">{{ $purchase['supplier_info']['supplier_email'] }}</span><br>
                            ...
                            <div class="col-sm-6">
                                ...
                                <span class="text-uppercase font-weight-bold text-bold" style="font-weight: 800">Order
                                    Status <span
                                        class="custom-badge status-{{ $purchase['color'] }} badge-border">{{ Str::limit($purchase['status_name'],30) }}</span>
                                </span><br>
                            </div>
    ...
    <script>
        ...
        function loadData() {
            table = $('#data_table').DataTable({
                ...
                columnDefs: [{
                    targets: [3,4], // Index of the column you want to center (0-based index)
                    className: 'text-center' // Your center class (can be any other class)
                }, {
                    targets: [5,6], // Index of the column you want to center (0-based index)
