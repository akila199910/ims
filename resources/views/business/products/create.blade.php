                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-xl-12">
                                <div class="input-block local-forms">
                                    ...
                                    <textarea name="sort_description" id="sort_description" class="form-control sort_description" rows="2"></textarea>
                            ...
                            <div class="col-12 col-md-12 col-xl-12">
                                <div class="input-block local-forms">
                                    <label for="full_description">Full Description <span
                                            class="text-danger">*</span></label>
                                    <textarea name="full_description" id="full_description" class="form-control full_description" rows="4"></textarea>
    ...
    <script>
        ...
        $('#submitForm').submit(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('business.products.create') }}",
                data: formData,
                contentType: false,
                cache: false,
                processData: false,
