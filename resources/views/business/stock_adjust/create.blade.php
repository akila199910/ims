        ...
        <div class="row">
            <div class="col-sm-8">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add new Stock Adjusted</li>
                </ul>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-heading">
                                    <h4>Add new Stock Adjusted <small class="text-primary-emphasis" style="font-size: 12px !important">(Select the Purchase Product ID to get the product)</small></h4>
...
@section('scripts')
    <script>
        ...
        $('#purchase_ref').change(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('stock_adjusted.Stock_item_filter')}}",
                data: data,
        ...
        $('#submitForm').submit(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('business.stock_adjusted.create') }}",
                data: formData,
                contentType: false,
                cache: false,
                processData: false,
