...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:;">Manage Purchased Lists</a></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row align-items-center mb-2">
                            <div class="col">
                                <div class="doctor-table-blk">
                                    <h3 class="text-uppercase">Purchased Lists</h3>
                                </div>
                            </div>
    ...
    <script>
        ...
        function loadData() {
            table = $('#data_table').DataTable({
                ...
                orderable: false,
                ajax: {
                    url: "{{ route('business.purchases', ['json' => 1]) }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ route('business.purchases.delete') }}",
                                data: data,
