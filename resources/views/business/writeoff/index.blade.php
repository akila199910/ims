...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:;">Manage Write Offs </a></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row align-items-center mb-2">
                            <div class="col">
                                <div class="doctor-table-blk">
                                    <h3 class="text-uppercase">Write Offs</h3>
                                </div>
                            </div>
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                @if (Auth::user()->hasPermissionTo('Create_WriteOff'))
                                    <a href="{{ route('business.writeoff.create.form') }}" class="btn btn-primary ms-2">
                                        +&nbsp;New Write Off
                                    </a>
                                @endif
                            </div>
        ...
        $(document).ready(function() {
            ...
            function loadData() {
                table = $('#data_table').DataTable({
                    ...
                    orderable: false,
                    ajax: {
                        url: "{{ route('business.writeoff', ['json' => 1]) }}"
                    },
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function() {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "{{ route('business.writeoff.delete') }}",
                                data: data,
