...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col-sm-8">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('business.purchase_return') }}">Manage Approval History</a></li>
    ...
    <script>
        ...
        function loadData() {
            table = $('#data_table').DataTable({
                ...
                orderable: false,
                ajax: {
                    url: "{{ route('business.purchase_return.approval_history_list', ['json' => 1]) }}",
                    data: function(d) {
                ...
                columns: [{
                    ...
                    {
                        data: 'invoice_id',
                        name: 'pur_return_Info.invoice_id',
                        orderable: false,
                    },
                    {
                        data: 'modify_by',
