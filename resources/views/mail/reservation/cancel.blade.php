                                    ...
                                    <table cellspacing="5" cellpadding="5" border="0">
                                        ...
                                        <tr>
                                            <td
                                                style="font-size: 16px; letter-spacing: 1px; font-weight:500;color:#5C7575;text-transform:uppercase;font-family: 'Lexend', sans-serif;    padding: 5px 0;">
                                                Requested Date :
                                                {{ date('jS, M Y', strtotime($reservation->request_date)) }}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td
                                                style="font-size: 16px; letter-spacing: 1px; font-weight:500;color:#5C7575;text-transform:uppercase;font-family: 'Lexend', sans-serif;    padding: 5px 0;">
                                                Amount :
                                                {{ number_format($reservation->amount + $reservation->extra_amount + $reservation->service_amount - $reservation->discount, 2, '.', '') }}
                                            </td>
                                        </tr>
